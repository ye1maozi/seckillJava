...
public class CodeMsg {
    ...
    public static CodeMsg CONFILCT_REGISTER = new CodeMsg(100000, "昵称号码已存在");
    public static CodeMsg SERVER_ERROR = new CodeMsg(500100, "服务端异常");
    public static CodeMsg PASSWORD_ERROR = new CodeMsg(500215, "密码错误");
    public static CodeMsg INVAILD_NICK = new CodeMsg(100001, "非法昵称");
    ...
    //秒杀模块 5005XX
    public static CodeMsg SECKILL_GOODIS = new CodeMsg(500502, "商品不存在");
